...
_FEATURE_DEFS: list[dict[str, Any]] = [
    ...
    {"key": "voiceTtsProvider", "label": "Voice TTS Provider", "desc": "TTS engine. deepgram (fast EN), fish-speech (80+ langs), svara-tts (Indian langs) (emotional) (17 langs).", "category": "media", "type": "string", "default": "deepgram", "placeholder": "deepgram, fish-speech, svara-tts"},
    ...
    {"key": "phoneCallVoiceProvider", "label": "Call Voice Provider", "desc": "Voice provider for phone calls. deepgram = Twilio TTS.", "category": "media", "type": "string", "default": "deepgram", "placeholder": "deepgram, fish-speech, svara-tts"},
